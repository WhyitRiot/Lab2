...
INSERT INTO Customer (CustomerID, FirstName, LastName, Phone, "Address", Email, PhoneType, ContactMethod, MethodType, ServiceType) VALUES
(1, 'Wyatt', 'Putnam', '757-817-2307', '123 Street, Harrisonburg, VA, 22801', 'WyattPutnam@email.com', 'Home', '','','Moving')
INSERT INTO Customer (CustomerID, FirstName, LastName, Phone, "Address", Email, PhoneType, ContactMethod, MethodType,ServiceType) VALUES
(2, 'Jim', 'Halpert', '570-555-6127', '123 Avenue, Scranton, PA, 18503','JimHalpert@email.com','Work', '','','Auction')
INSERT INTO Customer (CustomerID, FirstName, LastName, Phone, "Address",Email, PhoneType, ContactMethod, MethodType,ServiceType) VALUES
(3, 'Pam', 'Beesly', '570-555-6128', '123 Avenue, Scranton, PA, 18503', 'PamBeesly@email.com','Cell', '','','Moving')
